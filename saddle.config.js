module.exports = {
  ...
  contracts:
    process.env["SADDLE_CONTRACTS"] || "contracts/*.sol tests/contracts/*.sol", // Glob to match contract files
  ...
  networks: {
    ...
    development: {
      providers: [
        // How to load provider (processed in order)
    ...
    mainnet: {
      ...
      web3: {
        gas: [{ env: "GAS" }, { default: "2011059" }],
        gas_price: [{ env: "GAS_PRICE" }, { default: "95000000000" }],
        options: {
          transactionConfirmationBlocks: 1,
          transactionBlockTimeout: 5,
        },
